 ...
 * @param parent
 */
serial_port_plotter::serial_port_plotter (QWidget *parent) :
  QMainWindow (parent),
  ui (new Ui::serial_port_plotter),
  ...
  NUMBER_OF_POINTS (500)
{
  ...
  this->setWindowTitle("Serial Port Plotter v1.3.0");
 ...
 * @brief Destructor
 */
serial_port_plotter::~serial_port_plotter()
{
    closeCsvFile();
...
void serial_port_plotter::createUI()
{
    ...
    ui->comboBaud->addItem ("1500000");
    ui->comboBaud->addItem ("3000000");
 ...
 */
void serial_port_plotter::setupPlot()
{
 ...
 */
void serial_port_plotter::enable_com_controls (bool enable)
{
  /* Com port properties */
 ...
 * @param stopBits
 */
void serial_port_plotter::openPort (QSerialPortInfo portInfo, int baudRate, QSerialPort::DataBits dataBits, QSerialPort::Parity parity, QSerialPort::StopBits stopBits)
{
 ...
 */
void serial_port_plotter::onPortClosed()
{
 ...
 * @param arg1
 */
void serial_port_plotter::on_comboPort_currentIndexChanged (const QString &arg1)
{
 ...
 */
void serial_port_plotter::portOpenedSuccess()
{
 ...
 */
void serial_port_plotter::portOpenedFail()
{
 ...
 * @brief Replot
 */
void serial_port_plotter::replot()
{
  ui->plot->xAxis->setRange (dataPointNumber - ui->spinPoints->value(), dataPointNumber);
  ui->plot->replot();
}
 ...
 * @param newData
 */
void serial_port_plotter::onNewDataArrived(QStringList newData)
{
 ...
 * @param arg1
 */
void serial_port_plotter::on_spinAxesMin_valueChanged(int arg1)
{
 ...
 * @param arg1
 */
void serial_port_plotter::on_spinAxesMax_valueChanged(int arg1)
{
 ...
 */
void serial_port_plotter::readData()
{
 ...
 * @param index
 */
//void serial_port_plotter::on_comboAxes_currentIndexChanged(int index)
//{
//    if(index == 0) {
 ...
 * @param arg1
 */
void serial_port_plotter::on_spinYStep_valueChanged(int arg1)
{
 ...
 */
void serial_port_plotter::on_savePNGButton_clicked()
{
 ...
 * @param event
 */
void serial_port_plotter::channel_selection (void)
{
 ...
 * @param item
 */
void serial_port_plotter::legend_double_click(QCPLegend *legend, QCPAbstractLegendItem *item, QMouseEvent *event)
{
    Q_UNUSED (legend)
    Q_UNUSED(event)
 ...
 * @param arg1
 */
void serial_port_plotter::on_spinPoints_valueChanged (int arg1)
{
    Q_UNUSED(arg1)
    ui->plot->xAxis->setRange (dataPointNumber - ui->spinPoints->value(), dataPointNumber);
    ui->plot->replot();
 ...
 */
void serial_port_plotter::on_actionHow_to_use_triggered()
{
  helpWindow = new serial_port_plotter_HelpWindow (this);
 ...
 */
void serial_port_plotter::on_actionConnect_triggered()
{
  if (connected)
    {
 ...
 */
void serial_port_plotter::on_actionPause_Plot_triggered()
{
  if (plotting)
    {
 ...
 * @brief Keep COM port open but pause plotting
 */
void serial_port_plotter::on_actionRecord_stream_triggered()
{
    if (ui->actionRecord_stream->isChecked())
    {
 ...
 */
void serial_port_plotter::on_actionDisconnect_triggered()
{
  if (connected)
    {
 ...
 */
void serial_port_plotter::on_actionClear_triggered()
{
...
/**
 * @brief serial_port_plotter::on_actionExit_Window_triggered
 */
void serial_port_plotter::on_actionExit_Window_triggered()
{
    this->hide();
    emit signal_file_transfer_exit();
}
 ...
 *
 */
void serial_port_plotter::openCsvFile(void)
{
 ...
 *
 */
void serial_port_plotter::closeCsvFile(void)
{
  if(!m_csvFile) return;
  m_csvFile->close();
 ...
 *
 */
void serial_port_plotter::saveStream(QStringList newData)
{
  if(!m_csvFile)
    return;
  if(ui->actionRecord_stream->isChecked())
...
void serial_port_plotter::on_pushButton_TextEditHide_clicked()
{
...
void serial_port_plotter::on_pushButton_ShowallData_clicked()
{
...
void serial_port_plotter::on_pushButton_AutoScale_clicked()
{
...
void serial_port_plotter::on_pushButton_ResetVisible_clicked()
{
    for(int i=0; i<ui->plot->graphCount(); i++)
    {
...
void serial_port_plotter::on_listWidget_Channels_itemDoubleClicked(QListWidgetItem *item)
{
...
void serial_port_plotter::on_pushButton_clicked()
{
    ui->comboPort->clear();
    /* List all available serial ports and populate ports combo box */
    for (QSerialPortInfo port : QSerialPortInfo::availablePorts())
