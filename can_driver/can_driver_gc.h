 ...
 */
#ifndef CAN_DRIVER_GC_H
#define CAN_DRIVER_GC_H
/** Includes -----------------------------------------------------------------*/
...
class can_driver_gc : public can_driver_model
{
  Q_OBJECT
public:
   ...
   * @return
   */
  static can_driver_model::SET_FUNCTION_CAN_USE_Typedef_t function_can_use_update_for_choose(const QString &device_type_str = "GC_USBCAN_II");
...
private:
  ...
  /* gc消息 */
  void show_rec_message(const CHANNEL_STATE_Typedef_t &channel_state, const GC_CAN_OBJ *data, quint32 len, CAN_DIRECT_Typedef_t dir);
  void show_rec_message(const CHANNEL_STATE_Typedef_t &channel_state, const GC_CANFD_OBJ *data, quint32 len, CAN_DIRECT_Typedef_t dir);
};

#endif // CAN_DRIVER_GC_H
/******************************** End of file *********************************/
